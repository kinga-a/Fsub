...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .login-box h2 { font-size: 24px; margin-bottom: 8px; color: #111827; }
        ...
        .header h1 { font-size: 26px; color: #111827; font-weight: 700; }
        ...
        .stat-card .value.expired { color: #ef4444; }
        ...
        tr { border-bottom: 1px solid #f3f4f6; transition: background 0.2s; }
        tr:last-child { border-bottom: none; }
        tr:hover { background: #fafafa; }
        .service-name { font-weight: 700; color: #111827; font-size: 15px; }
        .tag {
        ...
        .modal-header h3 { font-size: 20px; color: #111827; font-weight: 700; }
        ...
        .empty-state h3 { color: #111827; margin-bottom: 8px; font-size: 18px; }
...
<body>
    ...
    <div class="login-overlay" id="loginOverlay">
        <div class="login-box">
            ...
            <div class="error-msg" id="loginError">访问码错误，请重试</div>
        </div>
    </div>
        ...
        <div class="modal">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label>服务名称 *</label>
                    <input type="text" id="mName" placeholder="例如：Netflix、Spotify、ChatGPT Plus">
                </div>
                <div class="form-row">
                    <div class="form-group">
                        <label>价格 *</label>
                ...
                <div class="form-group">
                    <label>备注</label>
                    <input type="text" id="mNote" placeholder="可选：账号信息、共享人数、自动续费等">
                </div>
            </div>
